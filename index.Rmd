...
Últimos datos del CCAES adquiridos el `r format(max(covid_es$date), "%A, %d de %B, %Y")`, del JHU CCSE el `r format(max(coronavirus$date), "%A, %d de %B, %Y")`, y el tablero ha sido actualizado el `r format(Sys.Date(), "%A, %d de %B, %Y")`.
