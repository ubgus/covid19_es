...
valueBox(
  value = paste(format(df$confirmados, decimal.mark = ","), "", sep = " "),
...
valueBox(
  value = paste(format(df$fallecidos, decimal.mark = ","), " (",
    round(100 * df$fallecidos / df$confirmados, 1),
    "%)",
    sep = ""
  ),
...
valueBox(
  value = paste(format(df$recuperados, decimal.mark = ","), "", sep = " "),
  caption = "Casos Activos totales",
  icon = "fa-lung-virus",
...
valueBox(
  value = paste(format(df$activos, decimal.mark = ","), "", sep = " "),
  caption = "Casos Activos totales",
  icon = "fa-lung-virus",
  color = active_color
)
...
Últimos datos adquiridos del CCAES el `r format(max(covid_es$date), "%A, %d de %B, %Y")`. 
Últimos datos adquiridos del JHU CCSE el `r format(max(coronavirus$date), "%A, %d de %B, %Y")`
